        ...
        <div className="left-content">
          ...
          <div className="benefits-grid">
            <div className="benefit-card">
              ...
              <p>Detect scope gaps, conflicts, and inconsistencies in your construction documents, before they turn into RFIs, change orders, or budget overruns.</p>
            </div>
            ...
            <div className="benefit-card">
              ...
              <p>Wyre AI analyzes your full document set and generates structured scopes and bid items, accelerating scope review and bid preparation.</p>
            </div>
            ...
            <div className="benefit-card">
              ...
              <p>Deliver complete, traceable scopes backed by source references — giving teams the confidence to submit bids knowing critical details haven't been missed.</p>
            </div>
          </div>
